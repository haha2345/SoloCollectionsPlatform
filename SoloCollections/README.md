...
- 统一收藏窗口：坐骑、小宠物、外观物品和套装页面；幻化为独立窗口，由单独按钮打开。玩具箱与头衔页暂不上线，分别在 `feat/deferred-toy-box` 与 `feat/deferred-title-journal`。
...
2026-08-18 参考客户端已通过收藏手册与独立幻化室验收，详见
[验收记录](docs/evidence/2026-08-18-collections-transmog-acceptance.md)
和 [STATUS.md](docs/STATUS.md)。物品页镜头仍有可贡献空间：不同种族、性别、
